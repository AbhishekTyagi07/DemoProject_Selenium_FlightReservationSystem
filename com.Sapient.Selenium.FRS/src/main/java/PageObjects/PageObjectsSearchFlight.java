...
public class PageObjectsSearchFlight {

	WebDriver driver;
	
	//Class constructor
	public PageObjectsSearchFlight(WebDriver driver){
		this.driver = driver;
	...
	public void searchFlight() throws IOException{
		...
		//Click on trip radio button either one way or round trip
		trip.click();
		
		//Select the number of passengers
		Select passCount = new Select((WebElement) passengerCount);
		passCount.selectByValue(Utilities.getDataFromExcel("passcount","TestData"));
		
		//Select source location
		Select srcPort = new Select((WebElement) fromPort);
		srcPort.selectByValue(Utilities.getDataFromExcel("fromport","TestData"));
		
		//Select month of travel
		Select srcMonth = new Select((WebElement) fromMonth);
		srcMonth.selectByValue(Utilities.getDataFromExcel("frommonth","TestData"));
		
		//Select day of travel
		Select srcDay = new Select((WebElement) fromDay);
		srcDay.selectByValue(Utilities.getDataFromExcel("fromday","TestData"));
		
		//Select destination location
		Select destPort = new Select((WebElement) toPort);
		destPort.selectByValue(Utilities.getDataFromExcel("toport","TestData"));
		
		//Select month of travel
		Select destMonth = new Select((WebElement) toMonth);
		destMonth.selectByValue(Utilities.getDataFromExcel("tomonth","TestData"));
		
		//Select day of travel
		Select destDay = new Select((WebElement) toDay);
		destDay.selectByValue(Utilities.getDataFromExcel("today","TestData"));
